...
import (
	...
	"github.com/jaredbancroft/aoc2020/pkg/seating"
...
var day11Cmd = &cobra.Command{
	Use:   "day11",
	Short: "Advent of Code 2020 - Day 11: Seating System",
	Long: `
	Advent of Code 2020
	...
	As you reach the waiting area to board the ferry, you realize you're so early, nobody 
	...
	on the number of occupied seats adjacent to a given seat (one of the eight positions 
	immediately up, down, left, right, or diagonal from the seat). The following rules 
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		seatLayout, err := helpers.ReadStringFile(input)
		if err != nil {
			return err
		}

		sl, err := seating.NewSeatLayout(seatLayout)
		if err != nil {
			return err
		}
		sl2, err := seating.NewSeatLayout(seatLayout)
		if err != nil {
			return err
		}
		...
		fmt.Println("Occupied Seats: ", sl.Count())

		sl2.Model2()

		fmt.Println("Occupied Seats2: ", sl2.Count())
