...
var day2Cmd = &cobra.Command{
	Use:   "day2",
	Short: "Advent of Code 2020 - Day 2: Password Philosophy",
	Long: `
	Advent of Code 2020
	...
	Each line gives the password policy and then the password. d
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for _, input := range inputs {
			...
			if p.ValidatePosition() {
				countPosition++
			}
		}

		fmt.Println("Valid passwords based on number: ", countNumber)
		fmt.Println("Valid passwords based on position: ", countPosition)
