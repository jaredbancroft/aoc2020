...
import (
	...
	"github.com/jaredbancroft/aoc2020/pkg/toboggan"
...
var day3Cmd = &cobra.Command{
	Use:   "day3",
	Short: "Advent of Code 2020 - Day 3: Toboggan Trajectory",
	Long: `
	Advent of Code 2020
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		inputs, err := helpers.ReadStringFile(input)
		if err != nil {
			return err
		}

		treeMap := toboggan.NewTreeMap(inputs)
		trees := treeMap.Traverse(3, 1)
		fmt.Println("Trees hit: ", trees)
		product := treeMap.Traverse(1, 1) * treeMap.Traverse(3, 1) * treeMap.Traverse(5, 1) * treeMap.Traverse(7, 1) * treeMap.Traverse(1, 2)
		fmt.Println("Trees hit: ", product)
		return nil
	},
}
